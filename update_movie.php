<?php
    ...
    if (isset($_POST['updateBtn'])){
        ...
        if (mysqli_query($connect, $updateQuery)) {
            echo"<script>
                alert('You have successfully updated the movie: ".$movie['title']."');
                window.location='update_movie.php?movie_id=" . $movie['movie_id'] . "';
            </script>";
        } else {
            echo"<script>
                alert('Failed to update the movie: ".$movie['title']."');
                window.location='update_movie.php?movie_id=" . $movie['movie_id'] . "';
            </script>";
        }
    }
    ...
    if(isset($_POST['deleteBtn'])){
        ...
        if (mysqli_query($connect, $sql)) {
            echo"<script>
                alert('You have successfully deleted the movie: ".$movie['title']."');
                window.location='movies_admin.php';
            </script>";
        } else {
            echo"<script>
                alert('Failed to delete the movie: ".$movie_id."');
                window.location='update_movie.php?movie_id=" . $movie['movie_id'] . "';
            </script>";
        }
    }
...
<body>
    <div id="main"> 
        <form method="POST" enctype="multipart/form-data">
            <div class="details">
                <div class="detail1">
                    <img id="movieImagePreview" src="data:image/jpeg;base64,<?php echo base64_encode($movie['movie_image']); ?>" alt="<?php echo $movie['title']; ?>">
                    <br>
                    ...
                    <br>
                    <input type="submit" value="Delete Movie" class="detailBtn" name="deleteBtn">
                    <br>
                ...
                <div class="detail2">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    $sql2 = "SELECT AVG(rating) as average_rating FROM review WHERE movie_id = '$movie_id'";  
